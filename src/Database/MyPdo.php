...
final class MyPdo extends \PDO
{
     ...
     * @param null|string $username Utilisateur pour la connexion BD
     * @param null|string $password Mot de passe pour la connexion BD
     * @param null|array  $options  Options du pilote BD
     */
...
MyPDO::setConfiguration('mysql:host=mariadb;dbname=cutron01_music;charset=utf8', 'web', 'web');
